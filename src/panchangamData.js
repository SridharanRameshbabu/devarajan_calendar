...
function getDayType(events) {
    if (!events || events.length === 0) return DAY_TYPES.REGULAR;

    const majorFestivals = [
        "தை பொங்கல்", "மாட்டு பொங்கல்", "காணும் பொங்கல்", "போகி",
        "குடியரசு தினம்", "ஆங்கில புத்தாண்டு", "தீபாவளி", "மகர சங்கராந்தி"
    ];
    ...
    return DAY_TYPES.AUSPICIOUS; // Default to auspicious for other named events
}

// January 2026 data from JSON with events.    //corrected-tamil-date and thithi
const JANUARY_2026_DATA = {
    1: { tamil_date: "மார்கழி 17", nakshatra: "ரோகிணி", tithi: "த்ரயோதசி", events: ["ஆங்கில புத்தாண்டு"] },
    2: { tamil_date: "மார்கழி 18", nakshatra: "மிருகசீரிடம்", tithi: "சதுர்த்தசி", events: [] },
    3: { tamil_date: "மார்கழி 19", nakshatra: "திருவாதிரை", tithi: "பௌர்ணமி", events: [] },
    4: { tamil_date: "மார்கழி 20", nakshatra: "புனர்பூசம்", tithi: "பிரதமை", events: [] },
    5: { tamil_date: "மார்கழி 21", nakshatra: "பூசம்", tithi: "துவிதியை", events: [] },
    6: { tamil_date: "மார்கழி 22", nakshatra: "ஆயில்யம்", tithi: "த்ரிதியை", events: [] },
    7: { tamil_date: "மார்கழி 23", nakshatra: "மகம்", tithi: "சதுர்த்தி", events: [] },
    8: { tamil_date: "மார்கழி 24", nakshatra: "பூரம்", tithi: "பஞ்சமி", events: [] },
    9: { tamil_date: "மார்கழி 25", nakshatra: "உத்திரம்", tithi: "ஷஷ்டி", events: [] },
    10: { tamil_date: "மார்கழி 26", nakshatra: "அஸ்தம்", tithi: "ஸப்தமி", events: [] },
    11: { tamil_date: "மார்கழி 27", nakshatra: "சித்திரை", tithi: "அஷ்டமி", events: ["கூடாரவல்லி(ஆண்டாள் வரதன் திருக்கல்யாணம்)", "ஏகாதசி"], image: andal_malai },
    12: { tamil_date: "மார்கழி 28", nakshatra: "சுவாதி", tithi: "நவமி", events: [] },
    ...
    23: { tamil_date: "தை 9", nakshatra: "பூரட்டாதி", tithi: "பஞ்சமி", events: [] },
    24: { tamil_date: "தை 10", nakshatra: "உத்திரட்டாதி", tithi: "ஷஷ்டி", events: [] },
    25: { tamil_date: "தை 11", nakshatra: "ரேவதி", tithi: "ஸப்தமி", events: ["ரத சப்தமி"], image: radha_sapthami },
    26: { tamil_date: "தை 12", nakshatra: "அஸ்வினி", tithi: "அஷ்டமி", events: ["குடியரசு தினம்"] },
    27: { tamil_date: "தை 13", nakshatra: "பரணி", tithi: "நவமி", events: [] },
    28: { tamil_date: "தை 14", nakshatra: "கார்த்திகை", tithi: "தசமி", events: [] },
    29: { tamil_date: "தை 15", nakshatra: "ரோகிணி", tithi: "ஏகாதசி", events: [] },
    30: { tamil_date: "தை 16", nakshatra: "திருவாதிரை", tithi: "துவாதசி", events: [] },
    31: { tamil_date: "தை 17", nakshatra: "புனர்பூசம்", tithi: "த்ரயோதசி", events: [] }
};

// Process data to add dayType based on events
...
const FEBRUARY_2026_DATA = {
    1: { tamil_date: "தை 18", nakshatra: "பூசம்", tithi: "பௌர்ணமி", events: ["தைப்பூசம்"] },
    ...
    5: { tamil_date: "தை 22", nakshatra: "உத்திரம்", tithi: "சதுர்த்தி", events: [] },
    6: { tamil_date: "தை 23", nakshatra: "அஸ்தம்", tithi: "பஞ்சமி", events: [] },
...
const MARCH_2026_DATA = {
    ...
    2: { tamil_date: "மாசி 18", nakshatra: "ஆயில்யம்", tithi: "சதுர்த்தசி", events: [] },
    3: { tamil_date: "மாசி 19", nakshatra: "மகம்", tithi: "பௌர்ணமி", events: [] },
    4: { tamil_date: "மாசி 20", nakshatra: "பூரம்", tithi: "பிரதமை", events: [] },
    5: { tamil_date: "மாசி 21", nakshatra: "உத்திரம்", tithi: "துவிதியை", events: [] },
    6: { tamil_date: "மாசி 22", nakshatra: "அஸ்தம்", tithi: "த்ரிதியை", events: [] },
    7: { tamil_date: "மாசி 23", nakshatra: "சித்திரை", tithi: "சதுர்த்தி", events: [] },
    8: { tamil_date: "மாசி 24", nakshatra: "சுவாதி", tithi: "பஞ்சமி", events: [] },
    9: { tamil_date: "மாசி 25", nakshatra: "விசாகம்", tithi: "ஷஷ்டி", events: [] },
    10: { tamil_date: "மாசி 26", nakshatra: "அனுஷம்", tithi: "ஸப்தமி", events: [] },
    11: { tamil_date: "மாசி 27", nakshatra: "கேட்டை", tithi: "அஷ்டமி", events: [] },
    12: { tamil_date: "மாசி 28", nakshatra: "மூலம்", tithi: "நவமி", events: [] },
    13: { tamil_date: "மாசி 29", nakshatra: "பூராடம்", tithi: "தசமி", events: [] },
    14: { tamil_date: "மாசி 30", nakshatra: "உத்திராடம்", tithi: "ஏகாதசி", events: ["ஏகாதசி"] },
...
// April 2026 data from JSON with events
const APRIL_2026_DATA = {
    1: { tamil_date: "பங்குனி 18", nakshatra: "உத்திரம்", tithi: "சதுர்த்தசி", events: ['பெருந்தேவி வரதன் திருக்கல்யாணம்'] },
    2: { tamil_date: "பங்குனி 19", nakshatra: "அஸ்தம்", tithi: "பௌர்ணமி", events: [] },
    ...
    5: { tamil_date: "பங்குனி 22", nakshatra: "விசாகம்", tithi: "த்ரிதியை", events: ["பங்குனி புஷ்பப்பல்லக்கு", "ஈஸ்டர்", "சங்கடஹர சதுர்த்தி"] },
    ...
    20: { tamil_date: "சித்திரை 7", nakshatra: "கார்த்திகை", tithi: "த்ரிதியை", events: ["பரமக்குடி ஈஸ்வரன் கோவில் கொடியேற்றம்"] },
    21: { tamil_date: "சித்திரை 8", nakshatra: "மிருகசீரிடம்", tithi: "பஞ்சமி", events: ["இரண்டாம் நாள் இரவு நந்திகேஸ்வரர் & கிளி"] },
    22: { tamil_date: "சித்திரை 9", nakshatra: "திருவாதிரை", tithi: "ஷஷ்டி", events: ["மூன்றாம் நாள் இரவு குண்டோதர வாகனம் & சிம்ம வாகனம்"] },
    23: { tamil_date: "சித்திரை 10", nakshatra: "புனர்பூசம்", tithi: "ஸப்தமி", events: ["நான்காம் நாள் இரவு கைலாச கார்ப்பகவிருட்சம் & அன்ன வாகனம்"] },
    24: { tamil_date: "சித்திரை 11", nakshatra: "பூசம்", tithi: "அஷ்டமி", events: ["ஐந்தாம் நாள் இரவு இராவண கைலாசம் & காமதேனு வாகனம்"] },
    25: { tamil_date: "சித்திரை 12", nakshatra: "ஆயில்யம்", tithi: "நவமி", events: ["ஆறாம் நாள் இரவு விருஷப சேவை"] },
    26: { tamil_date: "சித்திரை 13", nakshatra: "மகம்", tithi: "தசமி", events: ["ஏழாம் நாள் குதிரை வாகனம் திக் விஜயம்", "ஸ்ரீ சுந்தரராஜப் பெருமாள் முதல் நாள் திருநாள்"] },
    27: { tamil_date: "சித்திரை 14", nakshatra: "பூரம்", tithi: "ஏகாதசி", events: ["எட்டாம் நாள் இரவு அம்பாள் கதிர் குளித்தல் பல்லக்கு", "ஸ்ரீ சுந்தரராஜப் பெருமாள் இரண்டாம் நாள் திருநாள்", "ஏகாதசி"] },
    28: { tamil_date: "சித்திரை 15", nakshatra: "உத்திரம் ", tithi: "த்வாதசி", events: ["ஒன்பதாம் நாள் காலை மீனாட்சி திருக்கல்யாணம்  & இரவு பட்டணப்பிரவேசம்", "ஸ்ரீ சுந்தரராஜப் பெருமாள் மூன்றாம் நாள் திருநாள்"] },
    29: { tamil_date: "சித்திரை 16", nakshatra: "அஸ்தம்", tithi: "த்ரயோதசி", events: ["பத்தாம் நாள் காலை ரதாரோஹணம் & இரவு சப்தாவரணம்", "ஸ்ரீ சுந்தரராஜப் பெருமாள் நான்காம் நாள் திருநாள்"] },
    30: { tamil_date: "சித்திரை 17", nakshatra: "சித்திரை", tithi: "சதுர்த்தசி", events: ["பதினொன்றம் நாள் தீர்த்தவாரி", "சுந்தரராஜப் பெருமாள் கள்ளர் திருக்கோலத்தில் வைகை எழுந்தருளல்", "நரசிம்ம ஜெயந்தி"] }
};
...
const MAY_2026_DATA = {
    1: { tamil_date: "சித்திரை 18", nakshatra: "ஸ்வாதி", tithi: "பௌர்ணமி", events: ["குதிரை வாகனம் வண்டியூர் திருவிழா", "மே தினம்"] },
    2: { tamil_date: "சித்திரை 19", nakshatra: "விசாகம்", tithi: "பிரதமை", events: ["சேஷ வாகனம் மண்டூக மகரிஷி சாப விமோசனம்"] },
    3: { tamil_date: "சித்திரை 20", nakshatra: "விசாகம்", tithi: "த்விதியை", events: ["பெரிய திருவடி கருட வாகனம்", "சங்கடஹர சதுர்த்தி"] },
    4: { tamil_date: "சித்திரை 21", nakshatra: "அனுஷம்", tithi: "த்ரிதியை", events: ["ராஜாங்க சேவை"] },
    5: { tamil_date: "சித்திரை 22", nakshatra: "கேட்டை", tithi: "சதுர்த்தி", events: ["கள்ளர் திருக்கோலத்தில் ஆஸ்தானத்தை நோக்கி இரவு கண்ணாடி சேவை"] },
    6: { tamil_date: "சித்திரை 23", nakshatra: "மூலம்", tithi: "சதுர்த்தி", events: ["உற்சவ சாந்தி", "ஷஷ்டி விரதம்"] },
    ...
    18: { tamil_date: "வைகாசி 4", nakshatra: "ரோகிணி", tithi: "த்ரிதியை", events: ["2018 & 2019 சின்ன அழகர்"] },
    ...
    23: { tamil_date: "வைகாசி 9", nakshatra: "மகம்", tithi: "அஷ்டமி", events: ["நான்காம் நாள் காலை காளிங்க நர்த்தனம் திருப்பல்லக்கு — இரவு பெரிய திருவடி"] },
    24: { tamil_date: "வைகாசி 10", nakshatra: "பூரம்", tithi: "நவமி", events: ["ஐந்தாம் நாள் காலை குழலூதும்பிரான் திருப்பல்லக்கு — இரவு சிறிய திருவடி"] },
    25: { tamil_date: "வைகாசி 11", nakshatra: "உத்திரம்", tithi: "தசமி", events: ["ஆறாம் நாள் காலை கீதோபதேச திருப்பல்லக்கு — இரவு யானை வாகனம்"] },
    26: { tamil_date: "வைகாசி 12", nakshatra: "அஸ்தம்", tithi: "ஏகாதசி", events: ["ஏழாம் நாள் காலை ஸ்ரீதேவி பூதேவி திருக்கல்யாணம் - இரவு சூர்ணோத்ஸவம்.", "ஏகாதசி"] },
    ...
    30: { tamil_date: "வைகாசி 16", nakshatra: "விசாகம்", tithi: "பௌர்ணமி", events: ["ஸ்ரீ வரதராஜப் பெருமாள் 119வது வசந்தோத்ஸவம் முதல் நாள் கள்ளர் திருக்கோலத்தில் வைகை எழுந்தருளல்"] },
...
// June 2026 data from JSON with events
const JUNE_2026_DATA = {
    1: { tamil_date: "வைகாசி 18", nakshatra: "கேட்டை", tithi: "பிரதமை", events: ["சேஷ வாகனம் மண்டூக மகரிஷி சாப விமோசனம்"] },
    2: { tamil_date: "வைகாசி 19", nakshatra: "மூலம்", tithi: "த்விதியை", events: ["பெரிய திருவடி கருட வாகனம்"] },
    3: { tamil_date: "வைகாசி 20", nakshatra: "பூராடம்", tithi: "த்ரிதியை", events: ["சிறிய திருவடி அனுமந்த வாகனம்"] },
    4: { tamil_date: "வைகாசி 21", nakshatra: "உத்திராடம்", tithi: "சதுர்த்தி", events: ["கள்ளர் திருக்கோலத்தில் ஆஸ்தானத்தை நோக்கி புறப்படுதல்", "சங்கடஹர சதுர்த்தி"] },
    5: { tamil_date: "வைகாசி 22", nakshatra: "திருவோணம்", tithi: "பஞ்சமி", events: ["காலை ஆஸ்தானத்தை அடைதல் இரவு கண்ணாடி சேவை"] },
    6: { tamil_date: "வைகாசி 23", nakshatra: "திருவோணம்", tithi: "ஷஷ்டி", events: ["உற்சவ சாந்தி"] },
    7: { tamil_date: "வைகாசி 24", nakshatra: "அவிட்டம்", tithi: "ஸப்தமி", events: ["கந்தவடி உற்சவம்"] },
    8: { tamil_date: "வைகாசி 25", nakshatra: "சதயம்", tithi: "அஷ்டமி", events: [] },
    9: { tamil_date: "வைகாசி 26", nakshatra: "பூரட்டாதி", tithi: "நவமி", events: [] },
    10: { tamil_date: "வைகாசி 27", nakshatra: "உத்திரட்டாதி", tithi: "தசமி", events: [] },
    11: { tamil_date: "வைகாசி 28", nakshatra: "ரேவதி", tithi: "ஏகாதசி", events: ["ஏகாதசி"] },
    12: { tamil_date: "வைகாசி 29", nakshatra: "அஸ்வினி", tithi: "த்வாதசி", events: ["பிரதோஷம்"] },
    13: { tamil_date: "வைகாசி 30", nakshatra: "கார்த்திகை", tithi: "த்ரயோதசி", events: ["மாச சிவராத்திரி"] },
    14: { tamil_date: "வைகாசி 31", nakshatra: "ரோகிணி", tithi: "சதுர்த்தசி", events: ["ஆனி மாதம் தொடக்கம்"] },
    15: { tamil_date: "ஆனி 1", nakshatra: "மிருகசீரிடம்", tithi: "அமாவாசை", events: ["அமாவாசை"] },
    16: { tamil_date: "ஆனி 2", nakshatra: "திருவாதிரை", tithi: "த்விதியை", events: [] },
    17: { tamil_date: "ஆனி 3", nakshatra: "புனர்பூசம்", tithi: "த்ரிதியை", events: [] },
    18: { tamil_date: "ஆனி 4", nakshatra: "பூசம்", tithi: "சதுர்த்தி", events: [] },
    19: { tamil_date: "ஆனி 5", nakshatra: "ஆயில்யம்", tithi: "பஞ்சமி", events: [] },
    20: { tamil_date: "ஆனி 6", nakshatra: "மகம்", tithi: "ஷஷ்டி", events: [] },
    21: { tamil_date: "ஆனி 7", nakshatra: "பூரம்", tithi: "ஸப்தமி", events: [] },
    22: { tamil_date: "ஆனி 8", nakshatra: "உத்திரம்", tithi: "அஷ்டமி", events: ["ஆனி உதிரம்", "வ்ரிஷப வ்ரதம்"] },
    23: { tamil_date: "ஆனி 9", nakshatra: "அஸ்தம்", tithi: "நவமி", events: [] },
    24: { tamil_date: "ஆனி 10", nakshatra: "சித்திரை", tithi: "தசமி", events: [] },
    25: { tamil_date: "ஆனி 11", nakshatra: "சுவாதி", tithi: "ஏகாதசி", events: [] },
    26: { tamil_date: "ஆனி 12", nakshatra: "விசாகம்", tithi: "த்வாதசி", events: ["பிரதோஷம்", "முஹர்ரம்"] },
    27: { tamil_date: "ஆனி 13", nakshatra: "அனுஷம்", tithi: "த்ரயோதசி", events: [] },
    28: { tamil_date: "ஆனி 14", nakshatra: "கேட்டை", tithi: "சதுர்த்தசி", events: [] },
    29: { tamil_date: "ஆனி 15", nakshatra: "மூலம்", tithi: "பௌர்ணமி", events: ["சாவித்ரி விரதம்"] },
    30: { tamil_date: "ஆனி 16", nakshatra: "பூராடம்", tithi: "பிரதமை", events: [] }
};
...
// July 2026 data from JSON with events
const JULY_2026_DATA = {
    1: { tamil_date: "ஆனி 17", nakshatra: "அவிட்டம்", tithi: "பிரதமை", events: [] },
    2: { tamil_date: "ஆனி 18", nakshatra: "சதயம்", tithi: "த்விதியை", events: [] },
    3: { tamil_date: "ஆனி 19", nakshatra: "பூரட்டாதி", tithi: "த்ரிதியை", events: ["சங்கடஹர சதுர்த்தி"] },
    4: { tamil_date: "ஆனி 20", nakshatra: "உத்திரட்டாதி", tithi: "சதுர்த்தி", events: [] },
    5: { tamil_date: "ஆனி 21", nakshatra: "ரேவதி", tithi: "பஞ்சமி", events: ["ஷஷ்டி விரதம்"] },
    6: { tamil_date: "ஆனி 22", nakshatra: "அஸ்வினி", tithi: "ஷஷ்டி", events: [] },
    7: { tamil_date: "ஆனி 23", nakshatra: "பரணி", tithi: "ஸப்தமி", events: [] },
    8: { tamil_date: "ஆனி 24", nakshatra: "கார்த்திகை", tithi: "அஷ்டமி", events: [] },
    9: { tamil_date: "ஆனி 25", nakshatra: "ரோகிணி", tithi: "நவமி", events: [] },
    10: { tamil_date: "ஆனி 26", nakshatra: "மிருகசீரிடம்", tithi: "தசமி", events: [] },
    11: { tamil_date: "ஆனி 27", nakshatra: "திருவாதிரை", tithi: "த்வாதசி", events: ["பிரதோஷம்"] },
    12: { tamil_date: "ஆனி 28", nakshatra: "புனர்பூசம்", tithi: "த்ரயோதசி", events: ["மாத சிவராத்திரி"] },
    13: { tamil_date: "ஆனி 29", nakshatra: "பூசம்", tithi: "சதுர்த்தசி", events: [] },
    14: { tamil_date: "ஆனி 30", nakshatra: "ஆயில்யம்", tithi: "அமாவாசை", events: ["ஆடி மாதம் தொடக்கம்", "அமாவாசை"] },
    15: { tamil_date: "ஆனி 31", nakshatra: "மகம்", tithi: "பிரதமை", events: [] },
    16: { tamil_date: "ஆனி 32", nakshatra: "பூரம்", tithi: "த்விதியை", events: [] },
    17: { tamil_date: "ஆடி 1", nakshatra: "உத்திரம்", tithi: "த்ரிதியை", events: [] },
    18: { tamil_date: "ஆடி 2", nakshatra: "அஸ்தம்", tithi: "பஞ்சமி", events: ["சங்கடஹர சதுர்த்தி"] },
    19: { tamil_date: "ஆடி 3", nakshatra: "சித்திரை", tithi: "ஷஷ்டி", events: ["ஷஷ்டி விரதம்"] },
    20: { tamil_date: "ஆடி 4", nakshatra: "சுவாதி", tithi: "ஸப்தமி", events: [] },
    21: { tamil_date: "ஆடி 5", nakshatra: "விசாகம்", tithi: "அஷ்டமி", events: [] },
    22: { tamil_date: "ஆடி 6", nakshatra: "அனுஷம்", tithi: "நவமி", events: ["ஸ்ரீ சுந்தரராஜப் பெருமாள் ஆடி பிரமோற்சவம் முதல் நாள் அன்ன வாகனம்"] },
    23: { tamil_date: "ஆடி 7", nakshatra: "கேட்டை", tithi: "நவமி", events: ["இரண்டாம் நாள் சிம்ம வாகனம்"] },
    24: { tamil_date: "ஆடி 8", nakshatra: "மூலம்", tithi: "தசமி", events: ["மூன்றாம் நாள் சேஷ வாகனம்"] },
    25: { tamil_date: "ஆடி 9", nakshatra: "பூராடம்", tithi: "ஏகாதசி", events: ["நான்காம் நாள் பெரிய திருவடி கருட வாகனம்", "ஏகாதசி"] },
    26: { tamil_date: "ஆடி 10", nakshatra: "உத்திராடம்", tithi: "த்வாதசி", events: ["ஐந்தாம் நாள் சிறிய திருவடி அனுமந்த வாகனம்", "பிரதோஷம்"] },
    27: { tamil_date: "ஆடி 11", nakshatra: "திருவோணம்", tithi: "த்ரயோதசி", events: ["ஆறாம் நாள் யானை வாகனம்"] },
    28: { tamil_date: "ஆடி 12", nakshatra: "அவிட்டம்", tithi: "சதுர்த்தசி", events: ["ஏழாம் நாள் சூர்ணோத்ஸவம் "] },
    29: { tamil_date: "ஆடி 13", nakshatra: "சதயம்", tithi: "பௌர்ணமி", events: ["எட்டாம் நாள் காலை நவநீத கிருஷ்ணன் சேவை இரவு குதிரை வாகனம்", "ஆடி பௌர்ணமி"] },
    30: { tamil_date: "ஆடி 14", nakshatra: "பூரட்டாதி", tithi: "பிரதமை", events: ["ஒன்பதாம் நாள் ரதாரோஹணம் & சயனப் பல்லக்கு"] },
    31: { tamil_date: "ஆடி 15", nakshatra: "உத்திரட்டாதி", tithi: "த்விதியை", events: ["பத்தாம் நாள் காலை தீர்த்தவாரி இரவு த்வஜாவரோஹணம்"] }
};
...
// August 2026 data from JSON with events
const AUGUST_2026_DATA = {
    1: { tamil_date: "ஆடி 16", nakshatra: "சதயம்", tithi: "த்ரிதியை", events: [] },
    2: { tamil_date: "ஆடி 17", nakshatra: "பூரட்டாதி", tithi: "சதுர்த்தி", events: ["சங்கடஹர சதுர்த்தி"] },
    3: { tamil_date: "ஆடி 18", nakshatra: "உத்திராடம்", tithi: "பஞ்சமி", events: ["ஆடி பெருக்கு"] },
    4: { tamil_date: "ஆடி 19", nakshatra: "ரேவதி", tithi: "ஷஷ்டி", events: [] },
    5: { tamil_date: "ஆடி 20", nakshatra: "அஸ்வினி", tithi: "ஸப்தமி", events: [] },
    6: { tamil_date: "ஆடி 21", nakshatra: "பரணி", tithi: "அஷ்டமி", events: [] },
    7: { tamil_date: "ஆடி 22", nakshatra: "கார்த்திகை", tithi: "நவமி", events: ["ஆடி கிருத்திகை"] },
    8: { tamil_date: "ஆடி 23", nakshatra: "ரோகிணி", tithi: "தசமி", events: [] },
    9: { tamil_date: "ஆடி 24", nakshatra: "மிருகசீரிடம்", tithi: "ஏகாதசி", events: ["ஏகாதசி"] },
    ...
    14: { tamil_date: "ஆடி 29", nakshatra: "பூரம்", tithi: "த்விதியை", events: [] },
    ...
    17: { tamil_date: "ஆடி 32", nakshatra: "சித்திரை", tithi: "பஞ்சமி", events: ["சங்கடஹர சதுர்த்தி"] },
    18: { tamil_date: "ஆவணி 1", nakshatra: "சுவாதி", tithi: "ஷஷ்டி", events: [] },
    19: { tamil_date: "ஆவணி 2", nakshatra: "சுவாதி", tithi: "ஸப்தமி", events: [] },
    20: { tamil_date: "ஆவணி 3", nakshatra: "விசாகம்", tithi: "அஷ்டமி", events: [] },
    21: { tamil_date: "ஆவணி 4", nakshatra: "அனுஷம்", tithi: "நவமி", events: [] },
    22: { tamil_date: "ஆவணி 5", nakshatra: "கேட்டை", tithi: "தசமி", events: [] },
    23: { tamil_date: "ஆவணி 6", nakshatra: "மூலம்", tithi: "ஏகாதசி", events: [] },
    ...
    26: { tamil_date: "ஆவணி 9", nakshatra: "திருவோணம்", tithi: "த்ரயோதசி", events: ["கஜேந்திர மோட்சம்", "மீலாத்-உன்-நபி", "ஒணம்"] },
    27: { tamil_date: "ஆவணி 10", nakshatra: "அவிட்டம்", tithi: "பௌர்ணமி", events: [] },
...
// September 2026 data from JSON with events
const SEPTEMBER_2026_DATA = {
    ...
    8: { tamil_date: "ஆவணி 22", nakshatra: "பூசம்", tithi: "த்வாதசி", events: ["பிரதோஷம்"] },
    9: { tamil_date: "ஆவணி 23", nakshatra: "ஆயில்யம்", tithi: "த்ரயோதசி", events: ["மாத சிவராத்திரி"] },
    10: { tamil_date: "ஆவணி 24", nakshatra: "மகம்", tithi: "சதுர்த்தசி", events: ["அமாவாசை"] },
    11: { tamil_date: "ஆவணி 25", nakshatra: "பூரம்", tithi: "அமாவாசை", events: [] },
    12: { tamil_date: "ஆவணி 26", nakshatra: "உத்திரம்", tithi: "பிரதமை", events: [] },
    13: { tamil_date: "ஆவணி 27", nakshatra: "அஸ்தம்", tithi: "த்விதியை", events: [] },
    14: { tamil_date: "ஆவணி 28", nakshatra: "சித்திரை", tithi: "த்ரிதியை", events: ["விநாயகர் சதுர்த்தி"] },
    15: { tamil_date: "ஆவணி 29", nakshatra: "சுவாதி", tithi: "சதுர்த்தி", events: [] },
    16: { tamil_date: "ஆவணி 30", nakshatra: "விசாகம்", tithi: "பஞ்சமி", events: [] },
    17: { tamil_date: "ஆவணி 31", nakshatra: "அனுஷம்", tithi: "ஷஷ்டி", events: ["புரட்டாசி மாதம் தொடக்கம்"] },
    18: { tamil_date: "புரட்டாசி 1", nakshatra: "கேட்டை", tithi: "சப்தமி", events: [] },
    19: { tamil_date: "புரட்டாசி 2", nakshatra: "மூலம்", tithi: "அஷ்டமி", events: [] },
    20: { tamil_date: "புரட்டாசி 3", nakshatra: "பூராடம்", tithi: "நவமி", events: [] },
    21: { tamil_date: "புரட்டாசி 4", nakshatra: "உத்திராடம்", tithi: "தசமி", events: ["ஏகாதசி"] },
    22: { tamil_date: "புரட்டாசி 5", nakshatra: "உத்திராடம்", tithi: "ஏகாதசி", events: [] },
    23: { tamil_date: "புரட்டாசி 6", nakshatra: "திருவோணம்", tithi: "த்வாதசி", events: [] },
    24: { tamil_date: "புரட்டாசி 7", nakshatra: "அவிட்டம்", tithi: "த்ரயோதசி", events: ["பிரதோஷம்"] },
    25: { tamil_date: "புரட்டாசி 8", nakshatra: "சதயம்", tithi: "சதுர்த்தி", events: ["ஆனந்த விரதம்"], image: anandhaviradham },
    26: { tamil_date: "புரட்டாசி 9", nakshatra: "பூரட்டாதி", tithi: "பௌர்ணமி", events: [] },
    27: { tamil_date: "புரட்டாசி 10", nakshatra: "உத்திரட்டாதி", tithi: "பிரதமை", events: [] },
    28: { tamil_date: "புரட்டாசி 11", nakshatra: "ரேவதி", tithi: "த்விதியை", events: [] },
    29: { tamil_date: "புரட்டாசி 12", nakshatra: "அஸ்வினி", tithi: "த்ரிதியை", events: [] },
    30: { tamil_date: "புரட்டாசி 13", nakshatra: "பரணி", tithi: "சதுர்த்தி", events: [] }
};
...
// October 2026 data from JSON with events
const OCTOBER_2026_DATA = {
    1: { tamil_date: "புரட்டாசி 14", nakshatra: "கார்த்திகை", tithi: "பஞ்சமி", events: [] },
    ...
    9: { tamil_date: "புரட்டாசி 22", nakshatra: "உத்திரம்", tithi: "சதுர்த்தசி", events: ["அமாவாசை"] },
    10: { tamil_date: "புரட்டாசி 23", nakshatra: "அஸ்தம்", tithi: "அமாவாசை", events: [] },
    11: { tamil_date: "புரட்டாசி 24", nakshatra: "சித்திரை", tithi: "பிரதமை", events: ["நவராத்திரி முதல் நாள்"] },
    12: { tamil_date: "புரட்டாசி 25", nakshatra: "சுவாதி", tithi: "த்விதியை", events: ["நவராத்திரி இரண்டாம் நாள்"] },
    13: { tamil_date: "புரட்டாசி 26", nakshatra: "விசாகம்", tithi: "த்ரிதியை", events: ["நவராத்திரி மூன்றாம் நாள்", "சங்கடஹர சதுர்த்தி"] },
    14: { tamil_date: "புரட்டாசி 27", nakshatra: "அனுஷம்", tithi: "சதுர்த்தி", events: ["நவராத்திரி நான்காம் நாள்"] },
    15: { tamil_date: "புரட்டாசி 28", nakshatra: "கேட்டை", tithi: "பஞ்சமி", events: ["நவராத்திரி ஐந்தாம் நாள்"] },
    16: { tamil_date: "புரட்டாசி 29", nakshatra: "கேட்டை", tithi: "ஷஷ்டி", events: ["நவராத்திரி ஆறாம் நாள்"] },
    17: { tamil_date: "புரட்டாசி 30", nakshatra: "மூலம்", tithi: "ஸப்தமி", events: ["நவராத்திரி ஏழாம் நாள்"] },
    18: { tamil_date: "ஐப்பசி 1", nakshatra: "பூராடம்", tithi: "ஸப்தமி", events: ["நவராத்திரி எட்டாம் நாள்", "ஐப்பசி மாதம் தொடக்கம்"] },
    19: { tamil_date: "ஐப்பசி 2", nakshatra: "உத்திராடம்", tithi: "நவமி", events: ["நவராத்திரி ஒன்பதாம் நாள்", "ஆயுத பூஜை"] },
    ...
    24: { tamil_date: "ஐப்பசி 7", nakshatra: "உத்திரட்டாதி", tithi: "த்ரயோதசி", events: [] },
    25: { tamil_date: "ஐப்பசி 8", nakshatra: "ரேவதி", tithi: "சதுர்த்தசி", events: [] },
    26: { tamil_date: "ஐப்பசி 9", nakshatra: "அஸ்வினி", tithi: "பௌர்ணமி", events: ["ஐப்பசி பௌர்ணமி"] },
    27: { tamil_date: "ஐப்பசி 10", nakshatra: "பரணி", tithi: "பிரதமை", events: [] },
    28: { tamil_date: "ஐப்பசி 11", nakshatra: "கார்த்திகை", tithi: "த்ரிதியை", events: ["சங்கடஹர சதுர்த்தி"] },
    29: { tamil_date: "ஐப்பசி 12", nakshatra: "ரோகிணி", tithi: "சதுர்த்தசி", events: [] },
    30: { tamil_date: "ஐப்பசி 13", nakshatra: "மிருகசீரிடம்", tithi: "பஞ்சமி", events: [] },
    31: { tamil_date: "ஐப்பசி 14", nakshatra: "திருவாதிரை", tithi: "ஷஷ்டி", events: [] }
};
...
// November 2026 data from JSON with events
const NOVEMBER_2026_DATA = {
    1: { tamil_date: "ஐப்பசி 15", nakshatra: "பூசம்", tithi: "ஸப்தமி", events: [] },
    2: { tamil_date: "ஐப்பசி 16", nakshatra: "அயில்யம்", tithi: "அஷ்டமி", events: [] },
    3: { tamil_date: "ஐப்பசி 17", nakshatra: "மகம்", tithi: "நவமி", events: [] },
    4: { tamil_date: "ஐப்பசி 18", nakshatra: "பூரம்", tithi: "தசமி", events: [] },
    5: { tamil_date: "ஐப்பசி 19", nakshatra: "உத்திரம்", tithi: "ஏகாதசி", events: ["ஏகாதசி"] },
    6: { tamil_date: "ஐப்பசி 20", nakshatra: "அஸ்தம்", tithi: "த்வாதசி", events: ["பிரதோஷம்"] },
    7: { tamil_date: "ஐப்பசி 21", nakshatra: "சித்திரை", tithi: "த்ரயோதசி", events: [] },
    8: { tamil_date: "ஐப்பசி 22", nakshatra: "சுவாதி", tithi: "சதுர்த்தசி", events: ["வரதராஜப் பெருமாள் திருப்பதி அலங்கார சேவை", "தீபாவளி"] },
    9: { tamil_date: "ஐப்பசி 23", nakshatra: "சுவாதி", tithi: "அமாவாசை", events: [] },
    10: { tamil_date: "ஐப்பசி 24", nakshatra: "விசாகம்", tithi: "பிரதமை", events: [] },
    11: { tamil_date: "ஐப்பசி 25", nakshatra: "அனுஷம்", tithi: "த்விதியை", events: [] },
    12: { tamil_date: "ஐப்பசி 26", nakshatra: "கேட்டை", tithi: "த்ரிதியை", events: [] },
    13: { tamil_date: "ஐப்பசி 27", nakshatra: "மூலம்", tithi: "சதுர்த்தி", events: [] },
    14: { tamil_date: "ஐப்பசி 28", nakshatra: "பூராடம்", tithi: "பஞ்சமி", events: ["பிரதோஷம்"] },
    15: { tamil_date: "ஐப்பசி 29", nakshatra: "உத்திராடம்", tithi: "ஷஷ்டி", events: [] },
    16: { tamil_date: "ஐப்பசி 30", nakshatra: "திருவோணம்", tithi: "ஸப்தமி", events: [] },
    17: { tamil_date: "கார்த்திகை 1", nakshatra: "அவிட்டம்", tithi: "அஷ்டமி", events: ["கார்த்திகை மாதம் தொடக்கம்"] },
    18: { tamil_date: "கார்த்திகை 2", nakshatra: "சதயம்", tithi: "நவமி", events: [] },
    19: { tamil_date: "கார்த்திகை 3", nakshatra: "பூரட்டாதி", tithi: "நவமி", events: [] },
    20: { tamil_date: "கார்த்திகை 4", nakshatra: "பூரட்டாதி", tithi: "தசமி", events: ["ஏகாதசி"] },
    ...
    28: { tamil_date: "கார்த்திகை 12", nakshatra: "புனர்பூசம்", tithi: "சதுர்த்தி", events: [] },
    29: { tamil_date: "கார்த்திகை 13", nakshatra: "பூசம்", tithi: "ஷஷ்டி", events: [] },
    30: { tamil_date: "கார்த்திகை 14", nakshatra: "ஆயில்யம்", tithi: "ஸப்தமி", events: [] }
};
...
// December 2026 data from JSON with events
const DECEMBER_2026_DATA = {
    1: { tamil_date: "கார்த்திகை 15", nakshatra: "மகம்", tithi: "அஷ்டமி", events: [] },
    2: { tamil_date: "கார்த்திகை 16", nakshatra: "பூரம்", tithi: "நவமி", events: [] },
    3: { tamil_date: "கார்த்திகை 17", nakshatra: "உத்திரம்", tithi: "தசமி", events: [] },
    4: { tamil_date: "கார்த்திகை 18", nakshatra: "அஸ்தம்", tithi: "ஏகாதசி", events: ["ஏகாதசி"] },
    5: { tamil_date: "கார்த்திகை 19", nakshatra: "சித்திரை", tithi: "த்வாதசி", events: ["பிரதோஷம்"] },
    6: { tamil_date: "கார்த்திகை 20", nakshatra: "சுவாதி", tithi: "த்ரயோதசி", events: ["மாத சிவராத்திரி"] },
    7: { tamil_date: "கார்த்திகை 21", nakshatra: "விசாகம்", tithi: "சதுர்த்தசி", events: [] },
    8: { tamil_date: "கார்த்திகை 22", nakshatra: "அனுஷம்", tithi: "அமாவாசை", events: ["அமாவாசை"] },
    9: { tamil_date: "கார்த்திகை 23", nakshatra: "கேட்டை", tithi: "பிரதமை", events: [] },
    10: { tamil_date: "கார்த்திகை 24", nakshatra: "மூலம்", tithi: "பிரதமை", events: [] },
    11: { tamil_date: "கார்த்திகை 25", nakshatra: "பூராடம்", tithi: "த்விதியை", events: [] },
    12: { tamil_date: "கார்த்திகை 26", nakshatra: "உத்திராடம்", tithi: "த்ரிதியை", events: ["சங்கடஹர சதுர்த்தி"] },
    13: { tamil_date: "கார்த்திகை 27", nakshatra: "திருவோணம்", tithi: "சதுர்த்தி", events: [] },
    14: { tamil_date: "கார்த்திகை 28", nakshatra: "அவிட்டம்", tithi: "பஞ்சமி", events: [] },
    15: { tamil_date: "கார்த்திகை 29", nakshatra: "அவிட்டம்", tithi: "ஷஷ்டி", events: [] },
    16: { tamil_date: "மார்கழி 1", nakshatra: "சதயம்", tithi: "ஸப்தமி", events: [] },
    17: { tamil_date: "மார்கழி 2", nakshatra: "பூரட்டாதி", tithi: "அஷ்டமி", events: ["மார்கழி மாதம் தொடக்கம்"] },
    18: { tamil_date: "மார்கழி 3", nakshatra: "உத்திரட்டாதி", tithi: "நவமி", events: [] },
    19: { tamil_date: "மார்கழி 4", nakshatra: "ரேவதி", tithi: "தசமி", events: ["ஏகாதசி"] },
    20: { tamil_date: "மார்கழி 5", nakshatra: "அஸ்வினி", tithi: "ஏகாதசி", events: ["பிரதோஷம்"] },
    21: { tamil_date: "மார்கழி 6", nakshatra: "பரணி", tithi: "த்வாதசி", events: ["மாத சிவராத்திரி"] },
    22: { tamil_date: "மார்கழி 7", nakshatra: "கார்த்திகை", tithi: "த்ரயோதசி", events: [] },
    23: { tamil_date: "மார்கழி 8", nakshatra: "ரோகிணி", tithi: "சதுர்த்தசி", events: ["திருவாதிரை"] },
    24: { tamil_date: "மார்கழி 9", nakshatra: "திருவாதிரை", tithi: "பௌர்ணமி", events: [] },
    25: { tamil_date: "மார்கழி 10", nakshatra: "புனர்பூசம்", tithi: "த்விதியை", events: ["கிறிஸ்துமஸ்"] },
    26: { tamil_date: "மார்கழி 11", nakshatra: "பூசம்", tithi: "த்ரிதியை", events: [] },
    27: { tamil_date: "மார்கழி 12", nakshatra: "ஆயில்யம்", tithi: "சதுர்த்தி", events: ["சங்கடஹர சதுர்த்தி"] },
    28: { tamil_date: "மார்கழி 13", nakshatra: "மகம்", tithi: "பஞ்சமி", events: ["ஸ்ரீ வாரி சேவா குழு பொது பஜனை"] },
    29: { tamil_date: "மார்கழி 14", nakshatra: "பூரம்", tithi: "ஷஷ்டி", events: [] },
    30: { tamil_date: "மார்கழி 15", nakshatra: "உத்திரம்", tithi: "ஸப்தமி", events: [] },
    31: { tamil_date: "மார்கழி 16", nakshatra: "அஸ்தம்", tithi: "அஷ்டமி", events: [] }
};
...
// Store all month data - COMPLETE 2026 CALENDAR
const PANCHANGAM_2026 = {
    0: JANUARY_2026_DATA,   // January
    1: FEBRUARY_2026_DATA,  // February
    2: MARCH_2026_DATA,     // March
    3: APRIL_2026_DATA,     // April
    4: MAY_2026_DATA,       // May
    5: JUNE_2026_DATA,      // June
    6: JULY_2026_DATA,      // July
    7: AUGUST_2026_DATA,    // August
    8: SEPTEMBER_2026_DATA, // September
    9: OCTOBER_2026_DATA,   // October
    10: NOVEMBER_2026_DATA, // November
    11: DECEMBER_2026_DATA  // December
};

// Automatically assign images for special days across all months
function assignSpecialImages() {
    const tamilMonthLastDays = {}; // Track last Friday for each Tamil month

    // First pass: Find Pournami days and collect Tamil month info
    Object.keys(PANCHANGAM_2026).forEach(month => {
        ...
        Object.keys(monthData).forEach(day => {
            ...
            // Rama Navami Image Assignment
            // Month is Panguni, Thithi is Navami, and it must be before Pournami (March 27, 2026)
            if (data.tamil_date.startsWith("பங்குனி") && data.tithi === "நவமி") {
                const gregorianMonth = parseInt(month);
                const gregorianDay = parseInt(day);
                // In 2026, Panguni Shukla Navami is March 27
                if (gregorianMonth === 2 && gregorianDay === 27) {
                    data.image = ramanavami;
                    if (data.events && !data.events.includes("ஸ்ரீ ராம நவமி")) {
                        data.events.push("ஸ்ரீ ராம நவமி");
                        data.festival = data.events.join(", ");
                    }
                }
            }
            ...
            if (data.tamil_date.startsWith("ஆவணி") && (data.tithi === "பௌர்ணமி" || (data.events && data.events.includes("பௌர்ணமி")))) {
            ...
            if (data.tamil_date.startsWith("பங்குனி") && data.nakshatra === "உத்திரம்") {
                data.image = panguni_thirukalyanam; // Primary image
                data.secondaryImage = panguni_uthiram; // Secondary image
                data.leftImage = panguni_uthiram
                ...
                if (daysUntilWednesday > 0) {
                    ...
                    if (wedMonthData && wedMonthData[wedDay]) {
                        ...
                        if (!wedMonthData[wedDay].events.includes("ஶ்ரீநிவாசன் 108")) {
                            wedMonthData[wedDay].events.push("ஶ்ரீநிவாசன் 108 கலசாபிஷேகம்");
                        }
                    }
                }
            }
            ...
            if (data.tamil_date.startsWith("கார்த்திகை") && data.nakshatra === "கார்த்திகை") {
                ...
                if (data.events && !data.events.includes("திருமங்கை ஆழ்வார்")) {
                    data.events.push("திருமங்கை ஆழ்வார் ஜெயந்தி");
                }
            ...
            // Thaipusam - Thai month with Poosam nakshatra
            if (data.tamil_date.startsWith("தை") && data.nakshatra === "பூசம்") {
                if (data.image) {
                    data.leftImage = thaipusam;
                    data.secondaryImage = thaipusam;
                } else {
                    data.image = thaipusam;
                }
                if (data.events && !data.events.includes("தைப்பூசம்")) {
                    data.events.push("தைப்பூசம்");
                }
            }

            // Jestabisekam - Aani month with Kettai nakshatra
            if (data.tamil_date.startsWith("ஆனி") && data.nakshatra === "கேட்டை") {
                if (data.image) {
                    data.leftImage = jestabisekam;
                    data.secondaryImage = jestabisekam;
                } else {
                    data.image = jestabisekam;
                }
                if (data.events && !data.events.includes("ஜேஷ்டாபிஷேகம்")) {
                    data.events.push("ஜேஷ்டாபிஷேகம்");
                }
            }

            // Chakarathalwar Jeyanthi - Aani month with Chithirai nakshatra
            if (data.tamil_date.startsWith("ஆனி") && data.nakshatra === "சித்திரை") {
                if (data.image) {
                    data.leftImage = chakaram;
                    data.secondaryImage = chakaram;
                } else {
                    data.image = chakaram;
                }
                if (data.events && !data.events.includes("சக்கரத்தாழ்வார் ஜெயந்தி")) {
                    data.events.push("சக்கரத்தாழ்வார் ஜெயந்தி");
                }
            }

            // Laksharjanai - Karthigai month with Thiruvonam nakshatra
            if (data.tamil_date.startsWith("கார்த்திகை") && data.nakshatra === "திருவோணம்") {
                if (data.image) {
                    data.leftImage = laksh_arjanai;
                    data.secondaryImage = laksh_arjanai;
                } else {
                    data.image = laksh_arjanai;
                }
                if (data.events && !data.events.includes("லக்ஷார்ஜனை")) {
            ...
            if (data.tamil_date.startsWith("மார்கழி") && data.tithi === "ஏகாதசி" && parseInt(month) === 11) {
                if (data.image) {
                    ...
                    data.image = vaigundam;
                }
                if (data.events && !data.events.includes("வைகுண்ட ஏகாதசி")) {
                    data.events.push("வைகுண்ட ஏகாதசி");
                }
            }

            // Krishna Jayanthi (Gokulashtami) - Avani + Rohini + Ashtami
            if (data.tamil_date.startsWith("ஆவணி") && data.nakshatra === "ரோகிணி" && data.tithi === "அஷ்டமி") {
                if (data.image) {
                    data.leftImage = krishna_jayanthi;
                    data.secondaryImage = krishna_jayanthi;
                } else {
                    data.image = krishna_jayanthi;
                }
                // if (data.events && !data.events.includes("கிருஷ்ணர் ஜெயந்தி")) {
                //     data.events.push("கிருஷ்ணர் ஜெயந்தி");
                // }

                // Also add Uriyadi Urchavam for next day
                const gokulaDate = new Date(2026, parseInt(month), parseInt(day));
                const uriyadiDate = new Date(gokulaDate);
                uriyadiDate.setDate(uriyadiDate.getDate() + 2);

                const um = uriyadiDate.getMonth();
                const ud = uriyadiDate.getDate();

                if (PANCHANGAM_2026[um] && PANCHANGAM_2026[um][ud]) {
                    const uriyadiData = PANCHANGAM_2026[um][ud];
                    if (uriyadiData.image) {
                        uriyadiData.leftImage = uriyadi;
                        uriyadiData.secondaryImage = uriyadi;
                    } else {
                        uriyadiData.image = uriyadi;
                    }
                    if (uriyadiData.events && !uriyadiData.events.includes("உரியடி உற்சவம்")) {
                        uriyadiData.events.push("உரியடி உற்சவம்");
                    }
                }
            }

            // Track Aipasi Amavasai for Diwali Garudan (4 days after)
            if (data.tamil_date.startsWith("ஐப்பசி") && data.tithi === "அமாவாசை") {
                // Calculate the date 4 days after this
                const amavasaiDate = new Date(2026, parseInt(month), parseInt(day));
                const garudanDate = new Date(amavasaiDate);
                garudanDate.setDate(garudanDate.getDate() + 4);

                const gm = garudanDate.getMonth();
                const gd = garudanDate.getDate();

                if (PANCHANGAM_2026[gm] && PANCHANGAM_2026[gm][gd]) {
                    const garudanData = PANCHANGAM_2026[gm][gd];
                    if (garudanData.image) {
                        garudanData.leftImage = diwali_garudan;
                        garudanData.secondaryImage = diwali_garudan;
                    } else {
                        garudanData.image = diwali_garudan;
                    }
                    if (garudanData.events && !garudanData.events.includes("நாக பஞ்சமி")) {
                        garudanData.events.push("நாக பஞ்சமி");
                    }
                }
            }

            // Sri Math Nadanagopala Nayaki Swamigal Jeyanthi - Margazhi month with Mirugasiridam nakshatra
            if (data.tamil_date.startsWith("மார்கழி") && data.nakshatra === "மிருகசீரிடம்") {
                if (data.image) {
                    data.leftImage = nadanagopal;
                    data.secondaryImage = nadanagopal;
                } else {
                    data.image = nadanagopal;
                }
                if (data.events && !data.events.includes("ஸ்ரீ மந் நடன கோபால நாயகி சுவாமிகள் ஜெயந்தி")) {
                    data.events.push("ஸ்ரீ மந் நடன கோபால நாயகி சுவாமிகள் ஜெயந்தி");
                }
            }
            ...
            // Puratasi Saturdays - assign puratasi_1 to puratasi_4 based on Saturday count
            if (dayOfWeek === 6 && data.tamil_date.startsWith("புரட்டாசி")) { // Saturday
                // Track and count Puratasi Saturdays
                if (!data._puratasiSaturday) {
                    // We'll need a second pass for this, mark it for now
                    data._isPuratasiSaturday = true;
                }
            }

            if (dayOfWeek === 5) { // Friday
                const tamilDateParts = data.tamil_date.split(" ");
                const tamilMonthName = tamilDateParts[0];
                const tamilDayNum = parseInt(tamilDateParts[1]) || 0;

                if (!tamilMonthLastDays[tamilMonthName]) {
                    tamilMonthLastDays[tamilMonthName] = {
                        month: parseInt(month),
                        day: gregorianDay,
                        tamilDay: tamilDayNum,
                        data: data
                    };
                } else {
                    // Compare Tamil day numbers - keep the one with higher Tamil day
                    if (tamilDayNum > tamilMonthLastDays[tamilMonthName].tamilDay) {
                        tamilMonthLastDays[tamilMonthName] = {
                            month: parseInt(month),
                            day: gregorianDay,
                            tamilDay: tamilDayNum,
    ...
    // Vaikasi Vaganam Image sequence Logic
    let vaikasiAmavasai = null;
    Object.keys(PANCHANGAM_2026).forEach(month => {
        const monthData = PANCHANGAM_2026[month];
        Object.keys(monthData).forEach(day => {
            const data = monthData[day];
            if (data.tamil_date.startsWith("வைகாசி") &&
                (data.tithi === "அமாவாசை" || (data.events && data.events.includes("அமாவாசை")))) {
                if (!vaikasiAmavasai) {
                    vaikasiAmavasai = { month: parseInt(month), day: parseInt(day) };
                }
            }
        });
    });
    ...
    if (vaikasiAmavasai) {
        const vaganamImages = [day0, day1, day2, day3, day4, day5, day6, day7, day8, day9, day10, day11, day12, day13, day14, day15, day16, day17, day18, day19, day20];
        // const vaganamNames = [
        ...
        for (let i = 0; i < 21; i++) {
            ...
            const startDate = new Date(2026, vaikasiAmavasai.month, vaikasiAmavasai.day + 2 + i);
            ...
            if (PANCHANGAM_2026[m] && PANCHANGAM_2026[m][d]) {
                ...
                if (i === 18) {
                    dayData.secondaryImage = day18_1;
                }
    ...
    // Panguni Dhani Image Assignment
    // 4th day from the start of Panguni Uthiram
    let panguniUthiramStart = null;
    Object.keys(PANCHANGAM_2026).forEach(month => {
        const monthData = PANCHANGAM_2026[month];
        Object.keys(monthData).forEach(day => {
            const data = monthData[day];
            if (data.tamil_date.startsWith("பங்குனி") && data.nakshatra === "உத்திரம்") {
                if (!panguniUthiramStart) {
                    panguniUthiramStart = { month: parseInt(month), day: parseInt(day) };
                }
            }
        });
    });
    ...
    if (panguniUthiramStart) {
        // Find 4th day from start (March 31 + 4 = April 4)
        const dhaniDate = new Date(2026, panguniUthiramStart.month, panguniUthiramStart.day + 4);
        const m = dhaniDate.getMonth();
        const d = dhaniDate.getDate();
    ...
    Object.keys(PANCHANGAM_2026).forEach(month => {
        ...
        Object.keys(monthData).forEach(day => {
            const data = monthData[day];
            if (data.tamil_date.startsWith("புரட்டாசி")) {
                const gregorianDay = parseInt(day);
                const date = new Date(2026, parseInt(month), gregorianDay);
                const dayOfWeek = date.getDay();
                if (dayOfWeek === 6) { // Saturday
                    puratasiSaturdays.push({ month: parseInt(month), day: gregorianDay });
                }
            }
        });
    });

    // Sort by date and assign images
    puratasiSaturdays.sort((a, b) => a.month !== b.month ? a.month - b.month : a.day - b.day);
    puratasiSaturdays.forEach((sat, index) => {
        if (index < 4 && PANCHANGAM_2026[sat.month] && PANCHANGAM_2026[sat.month][sat.day]) {
            const dayData = PANCHANGAM_2026[sat.month][sat.day];
            if (dayData.image) {
                dayData.leftImage = puratasiSaturdayImages[index];
                dayData.secondaryImage = puratasiSaturdayImages[index];
            } else {
                dayData.image = puratasiSaturdayImages[index];
            }
            if (dayData.events && !dayData.events.includes("புரட்டாசி சனி")) {
                dayData.events.push("புரட்டாசி சனி");
            }
        }
    });

    // Chithirai Pournami Sequence (pmk_day_1 to pmk_day_11)
    // Day 6 (pmk_day_6) is Pournami, Days 1-5 before, Days 7-11 after
    let chithiraiPournami = null;
    Object.keys(PANCHANGAM_2026).forEach(month => {
        const monthData = PANCHANGAM_2026[month];
        Object.keys(monthData).forEach(day => {
            const data = monthData[day];
            if (data.tamil_date.startsWith("சித்திரை") && data.tithi === "பௌர்ணமி") {
    ...
    if (chithiraiPournami) {
        const pmkImages = [pmk_day_1, pmk_day_2, pmk_day_3, pmk_day_4, pmk_day_5, pmk_day_6, pmk_day_7, pmk_day_8, pmk_day_9, pmk_day_10, pmk_day_11];
        for (let i = 0; i < 11; i++) {
            // Day 6 (index 5) is Pournami day, so offset = day - 5 + i
            ...
            if (PANCHANGAM_2026[m] && PANCHANGAM_2026[m][d]) {
                ...
                // Check if image already exists (from Eswaran Kovil)
                if (dayData.image) {
                    // Don't overwrite - add pmk image as secondary/left
                    dayData.leftImage = pmkImages[i];
                    if (!dayData.imageArray) {
                        dayData.imageArray = [dayData.image, pmkImages[i]];
                    } else {
                        dayData.imageArray.push(pmkImages[i]);
                    }
                } else {
                    dayData.image = pmkImages[i];
                }

                // Add secondary image for Day 10 (index 9)
                if (i === 9) {
    ...
    if (chithiraiChithirai) {
        ...
        const eswaranImagesPerDay = [
            ...
            [pmk_eswaran_kovil_6], // Day 6
            [pmk_eswaran_kovil_7], // Day 7
            [pmk_eswaran_kovil_8], // Day 8
            [pmk_eswaran_kovil_9], // Day 9
            [pmk_eswaran_kovil_10], // Day 10 (Chithirai nakshatra day)
            [pmk_eswaran_kovil_11] // Day 11 (day after Chithirai nakshatra)
        ];

        // Assign images for 11 days: Day 1 starts 10 days before Chithirai-Chithirai, ending on Chithirai nakshatra day
        for (let i = 0; i < 11; i++) {
            const targetDate = new Date(2026, chithiraiChithirai.month, chithiraiChithirai.day - 10 + i);
            const m = targetDate.getMonth();
            const d = targetDate.getDate();
    ...
    if (aadiPournami) {
        ...
        for (let i = 0; i < 10; i++) {
            ...
            if (PANCHANGAM_2026[m] && PANCHANGAM_2026[m][d]) {
                const dayData = PANCHANGAM_2026[m][d];
                // For aadi8 (Pournami day, index 7), always assign the image
                if (i === 7) {
                    dayData.image = aadiImages[i];
                } else if (!dayData.image) {
                    // For other days, don't overwrite if image already exists
                    dayData.image = aadiImages[i];
                }
            }
        }
...
// Run the automatic image assignment
assignSpecialImages();

// Get Panchangam data for a specific date
export function getPanchangamData(year, month, day) {
    const monthData = PANCHANGAM_2026[month];
...
// Get Tamil date for a specific Gregorian date (from JSON data)
export function getTamilDate(year, month, day) {
    const data = getPanchangamData(year, month, day);
    if (data.tamil_date === "---") {
        return { day: day, month: "---", monthEn: "---" };
    }

    const parts = data.tamil_date.split(" ");
    const tamilMonth = parts[0];
    const tamilDay = parseInt(parts[1]) || day;
    ...
    return {
        day: tamilDay,
        month: tamilMonth,
        monthEn: monthMap[tamilMonth] || tamilMonth
    };
}

// Get Tamil months that span a Gregorian month
export function getTamilMonthsInGregorianMonth(year, month) {
    const daysInMonth = new Date(year, month + 1, 0).getDate();
    const uniqueMonths = [];

    for (let day = 1; day <= daysInMonth; day++) {
        const tamilDate = getTamilDate(year, month, day);
        if (tamilDate.month !== "---" && !uniqueMonths.find(m => m.name === tamilDate.month)) {
            uniqueMonths.push({ name: tamilDate.month, nameEn: tamilDate.monthEn });
        }
    }
